            ...
            <div class="all-sort-list2" @click="toSearch">
              ...
              >
                <h3>
                  ...
                  <a
                    href="javascript:"
                    :data-cotagroyName="c1.categoryName"
                  ...
                  <div class="subitem">
                    <dl class="fore">
                      <dt>
                        ...
                        <a
                          href="javascript:"
                          :data-cotagroyName="c2.categoryName"
                      ...
                      <dd>
                        <em v-for="c3 in c2.categoryChild" :key="c3.categoryId">
                          ...
                          <a
                            href="javascript:"
                            :data-cotagroyName="c3.categoryName"
...
export default {
  ...
  methods: {
    ...
    //但是随着用了节流之后,最后一次点击效果延迟两秒执行,会导致运行错乱,如果我们需要使用节流那么请设计三层设计,外层负责取消最后一次错乱

    showActions: throttle(function (index) {
      if (this.current !== -2) {
        this.current = index;
      }
    }, 200),
