        ...
        <div class="bread">
          ...
          <ul class="fl sui-tag">
            <li class="with-x" v-show="options.keyword">
              {{ options.keyword }}<i @click="removeParamsP">×</i>
            </li>
            <li class="with-x" v-show="options.categoryName">
              {{ options.categoryName }}<i @click="removeParamsQ">×</i>
            </li>
            <li class="with-x" v-show="options.trademark">
              {{ options.trademark }}<i @click="removeTM">×</i>
            </li>
            <li
              class="with-x"
